...
# Solución
## Solucion 1
- Usando la terminal de PicoCTF y obteniendo el archivo mediante wget, posteriormente dandole permisos y siguiento los pasos indicados en las pistas del reto.
```
jorge_moran-picoctf@webshell:~$ chmod +x warm
jorge_moran-picoctf@webshell:~$ ./warm -h
